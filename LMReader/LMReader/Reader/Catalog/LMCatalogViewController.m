...
@interface LMCatalogViewController () <UITableViewDelegate, UITableViewDataSource, LMBaseRefreshTableViewDelegate, UIGestureRecognizerDelegate, UIScrollViewDelegate>
...
-(void)loadCatalogList {
    ...
    __weak LMCatalogViewController* weakSelf = self;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.callBlock) {
        ...
        self.callBlock(didChange, blockArr, index);
    }
