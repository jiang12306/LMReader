//
//  LMRecommandMoreViewController.m
//  LMReader
//
//  Created by Jiang Kuan on 2018/9/11.
...
@interface LMRecommandMoreViewController () <UITableViewDelegate, UITableViewDataSource, LMBaseRefreshTableViewDelegate>
...
-(void)loadInterestOrEndDataWithPage:(NSInteger )page isRefreshingOrLoadMoreData:(BOOL )loadMore {
    ...
    __weak LMRecommandMoreViewController* weakSelf = self;
