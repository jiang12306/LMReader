//
//  LMTypeBookStoreTableViewCell.m
//  LMReader
//
...
@implementation LMTypeBookStoreTableViewCell

CGFloat typeBookStoreAligmentSpace = 20;
...
-(void)setupSubviews {
    ...
    if (!self.nameLab) {
        self.nameLab = [[UILabel alloc]initWithFrame:CGRectMake(self.coverIV.frame.origin.x + self.coverIV.frame.size.width + typeBookStoreAligmentSpace, self.coverIV.frame.origin.y, screenRect.size.width - self.coverIV.frame.size.width - typeBookStoreAligmentSpace * 3, 20)];
    ...
    if (!self.typeLab) {
        self.typeLab = [[UILabel alloc]initWithFrame:CGRectMake(screenRect.size.width - 50 - typeBookStoreAligmentSpace, self.frame.size.height - 25 - typeBookStoreAligmentSpace, 50, 25)];
...
-(void)setupContentBook:(Book *)book cellHeight:(CGFloat)cellHeight ivWidth:(CGFloat )ivWidth nameFontSize:(CGFloat )nameFontSize briefFontSize:(CGFloat )briefFontSize {
    ...
    CGSize briefLabSize = [self.briefLab sizeThatFits:CGSizeMake(screenRect.size.width - ivWidth - typeBookStoreAligmentSpace * 3, 9999)];
    if (briefLabSize.height > self.briefLab.font.lineHeight * 3) {
        briefLabSize.height = self.briefLab.font.lineHeight * 3;
    }
    self.briefLab.frame = CGRectMake(self.coverIV.frame.origin.x + self.coverIV.frame.size.width + typeBookStoreAligmentSpace, self.coverIV.frame.origin.y + (self.coverIV.frame.size.height - briefLabSize.height) / 2, briefLabSize.width, briefLabSize.height);
    
    self.nameLab.text = book.name;
    CGRect nameLabRect = CGRectMake(self.briefLab.frame.origin.x, self.coverIV.frame.origin.y, screenRect.size.width - ivWidth - typeBookStoreAligmentSpace * 3, 25);
    ...
    self.typeLab.frame = CGRectMake(screenRect.size.width - typeBookStoreAligmentSpace - typeLabSize.width - 5, self.coverIV.frame.origin.y + self.coverIV.frame.size.height - 25, typeLabSize.width + 5, 25);
