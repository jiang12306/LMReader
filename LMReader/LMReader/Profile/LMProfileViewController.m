...
- (void)viewDidLoad {
    ...
    UIImageView* arrowIV = [[UIImageView alloc]initWithFrame:CGRectMake(self.view.frame.size.width - 10 - 10.5, self.avatorIV.frame.origin.y + spaceX, 10.5, 20)];
    ...
    [arrowIV setTintColor:[UIColor blackColor]];
